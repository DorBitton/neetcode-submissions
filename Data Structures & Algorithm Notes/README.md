...
| [`data-structures/README.md`](./data-structures/README.md) | All data structures — List, Set, Dict, Stack, Queue, Heap |
...
| [`data-structures/stack.md`](./data-structures/stack.md) | Stack patterns, walkthroughs for 6 NeetCode problems |
| [`complexity/README.md`](./complexity/README.md) | Big-O scale, how to count loops, Python built-in costs |
| [`patterns/README.md`](./patterns/README.md) | Problem-solving patterns (two pointers, sliding window, etc.) |
| [`algorithms/README.md`](./algorithms/README.md) | Sorting, searching, graph traversal |
...
2. Identify what data structure the problem needs
